...
router.get("/:userId/profiles/doctors", async (req, res) => {
  try {
...
// Update doctor
router.put("/:userId/profiles/doctor/:id", async (req, res) => {
  try {
...
// Delete doctor
router.delete("/:userId/profiles/doctor/:id", async (req, res) => {
  try {
